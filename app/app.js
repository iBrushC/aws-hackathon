    ...
    return `
      <li>
        <article class="person-card">
          <span class="avatar"><img src="${p.photo}" alt=""></span>
...
function openClipModal(clip) {
  ...
  card.innerHTML = `
    <div style="background:#111;aspect-ratio:16/9;display:flex;align-items:center;justify-content:center;">
      <img src="${clip.poster}" alt="" style="width:100%;height:100%;object-fit:cover;opacity:0.7;"/>
    </div>
    <div style="padding:16px 20px;display:flex;flex-direction:column;gap:6px;">
      ...
      <p style="margin:6px 0 0;color:#9a9a9a;font-size:13px;">Clip source not attached in this demo. In production, this would stream the processed clip.</p>
